...
![ выполнение программы листинга ](image/4.png){#fig:004 width=70%}
...
ответ:
В данном случае мы запретили доступ к исполнению файла. Команда chmod отвечает за изменение прав доступа, 
"u" - изменение прав доступа для владельца, "-" - отмена определённых прав, "х" - права выполнения файла. 
...
объясните результат.
ответ: 
В данном случае мы добавили владельцу парва на исполнение файла. Команда chmod отвечает за изменение прав доступа, "u" - изменение прав доступа для владельца, "+" - добавление определённых прав, "х" - права выполнения файла. 
...
![ листинг данной программы ](image/9.png){#fig:009 width=70%}
...
![ работа данной программы ](image/10.png){#fig:010 width=70%}


# Выводы
в ходе выполнения лабораторной работы №10 мы приобрели навыки написания программ для работы с файлами
